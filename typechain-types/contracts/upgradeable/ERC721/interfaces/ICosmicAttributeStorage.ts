...
export interface ICosmicAttributeStorageInterface extends utils.Interface {
  functions: {
...
export interface ICosmicAttributeStorage extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ICosmicAttributeStorageInterface;
