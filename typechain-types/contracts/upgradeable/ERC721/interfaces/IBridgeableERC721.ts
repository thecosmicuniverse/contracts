...
export interface IBridgeableERC721Interface extends utils.Interface {
  functions: {
...
export interface IBridgeableERC721 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IBridgeableERC721Interface;
