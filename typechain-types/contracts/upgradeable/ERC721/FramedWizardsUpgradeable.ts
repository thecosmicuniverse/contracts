...
export interface FramedWizardsUpgradeableInterface extends utils.Interface {
  functions: {
    ...
    "setTokenURI(uint256,bytes)": FunctionFragment;
    "setTokenURIs(uint256[],bytes[])": FunctionFragment;
...
export interface FramedWizardsUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FramedWizardsUpgradeableInterface;
