...
export interface CosmicIslandLandUpgradeableInterface extends utils.Interface {
  functions: {
    ...
    "setTokenURI(uint256,uint256,uint256)": FunctionFragment;
    "setTokenURIs(uint256[],uint256[],uint256[])": FunctionFragment;
...
export interface CosmicIslandLandUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CosmicIslandLandUpgradeableInterface;
  ...
  functions: {
    ...
    setTokenURI(
      tokenId: PromiseOrValue<BigNumberish>,
      attrId: PromiseOrValue<BigNumberish>,
    ...
    setTokenURIs(
      tokenIds: PromiseOrValue<BigNumberish>[],
      attrIds: PromiseOrValue<BigNumberish>[],
      values: PromiseOrValue<BigNumberish>[],
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
