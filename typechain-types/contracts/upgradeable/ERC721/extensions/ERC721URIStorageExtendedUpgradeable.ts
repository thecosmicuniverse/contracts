...
export interface ERC721URIStorageExtendedUpgradeableInterface
...
export interface ERC721URIStorageExtendedUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC721URIStorageExtendedUpgradeableInterface;
