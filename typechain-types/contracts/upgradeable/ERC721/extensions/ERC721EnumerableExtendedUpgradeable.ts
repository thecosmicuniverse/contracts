...
export interface ERC721EnumerableExtendedUpgradeableInterface
...
export interface ERC721EnumerableExtendedUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC721EnumerableExtendedUpgradeableInterface;
