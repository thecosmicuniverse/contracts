...
export interface CosmicComponentsInterface extends utils.Interface {
  functions: {
...
export interface CosmicComponents extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CosmicComponentsInterface;
