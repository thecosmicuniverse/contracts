...
export interface CosmicRefinedResourcesInterface extends utils.Interface {
  functions: {
...
export interface CosmicRefinedResources extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CosmicRefinedResourcesInterface;
