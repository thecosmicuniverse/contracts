...
export interface MagicUpgradeableInterface extends utils.Interface {
  functions: {
...
export interface MagicUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MagicUpgradeableInterface;
