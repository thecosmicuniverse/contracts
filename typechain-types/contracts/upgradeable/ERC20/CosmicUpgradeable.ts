...
export interface CosmicUpgradeableInterface extends utils.Interface {
  functions: {
...
export interface CosmicUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CosmicUpgradeableInterface;
