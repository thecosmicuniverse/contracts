...
export interface FramedCosmicWizards2DInterface extends utils.Interface {
  functions: {
...
export interface FramedCosmicWizards2D extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FramedCosmicWizards2DInterface;
