...
export interface TreasuryUpgradeableInterface extends utils.Interface {
  functions: {
...
export interface TreasuryUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TreasuryUpgradeableInterface;
