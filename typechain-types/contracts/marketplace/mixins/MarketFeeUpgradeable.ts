...
export interface MarketFeeUpgradeableInterface extends utils.Interface {
  functions: {
...
export interface MarketFeeUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MarketFeeUpgradeableInterface;
