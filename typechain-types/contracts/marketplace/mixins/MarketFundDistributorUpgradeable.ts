...
export interface MarketFundDistributorUpgradeableInterface
...
export interface MarketFundDistributorUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MarketFundDistributorUpgradeableInterface;
